...
include $(CLEAR_VARS)
LOCAL_MODULE := sfml-m_window
LOCAL_SRC_FILES := lib/$(TARGET_ARCH_ABI)/libsfml-m_window.so
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/include
...
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/include
LOCAL_SHARED_LIBRARIES += sfml-system sfml-m_window
...
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/include
LOCAL_SHARED_LIBRARIES := sfml-m_window sfml-system openal
...
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/include
LOCAL_SHARED_LIBRARIES := sfml-m_window sfml-system
...
include $(CLEAR_VARS)
LOCAL_MODULE := sfml-m_window-d
LOCAL_SRC_FILES := lib/$(TARGET_ARCH_ABI)/libsfml-m_window-d.so
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/include
LOCAL_EXPORT_LDLIBS := -lEGL -llog -landroid
...
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/include
LOCAL_SHARED_LIBRARIES += sfml-system-d sfml-m_window-d
...
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/include
LOCAL_SHARED_LIBRARIES := sfml-m_window-d sfml-system-d openal
...
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/include
LOCAL_SHARED_LIBRARIES := sfml-m_window-d sfml-system-d
